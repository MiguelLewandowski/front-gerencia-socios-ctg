  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 p-6 max-w-[1200px] mx-auto w-full">
        <div className="mb-6">
          <h1 className="text-[#1737b7] text-[42px] font-bold mb-1.5 max-md:text-[34px]">Novo Sócio</h1>
        ...
        <section className="bg-white rounded-2xl p-6 mb-6 shadow-[0_4px_12px_rgba(0,0,0,0.08)]">
          ...
          <div className="flex items-center gap-5 mb-6 flex-wrap">
            <div className="w-[90px] h-[90px] rounded-full bg-blue-100 border-2 border-blue-300 flex items-center justify-center text-4xl text-blue-600 shrink-0">
              ⬆
            </div>
        ...
        {/* Botões */}
        <div className="flex justify-end gap-3.5 mt-6 mb-6 flex-wrap">
