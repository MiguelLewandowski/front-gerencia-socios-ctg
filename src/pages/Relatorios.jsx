  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 p-6">
        <div className="mb-6">
          <h1 className="text-[#1737b7] text-[42px] font-bold mb-1.5 max-md:text-[34px]">Relatórios</h1>
          <p className="text-gray-500 text-lg">Gere relatórios personalizados e exporte em diversos formatos</p>
        </div>

        {/* Configurar Relatório */}
        <section className="bg-white rounded-2xl shadow-[0_4px_12px_rgba(0,0,0,0.08)] mb-6 overflow-hidden">
          <div className="bg-[#edf4ff] px-6 py-4.5 font-bold text-[#1737b7] border-b border-blue-100">
            Configurar Relatório
          </div>
          <div className="p-6">
            <div className="flex flex-col gap-2 mb-5">
              <label className="text-sm font-bold">Tipo de Relatório *</label>
              <select value={tipoRelatorio} onChange={e => setTipoRelatorio(e.target.value)} className={inputClass}>
